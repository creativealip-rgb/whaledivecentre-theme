    ...
    <div class="wd-shell wd-story-shell">
      <div class="wd-story-grid">
        ...
        <aside class="wd-story-side">
          <section class="wd-side-card"><h3>Artikel Lainnya</h3><ul><?php foreach($other_posts as $p){ echo '<li><a href="'.esc_url(get_permalink($p)).'">'.esc_html(get_the_title($p)).'</a><small>'.esc_html(get_the_date('d M Y',$p)).'</small></li>'; } ?></ul></section>
