...
.whaledive-courses #courseGrid.wd-page-grid{grid-template-columns:repeat(3,minmax(0,1fr))!important;gap:16px!important}.whaledive-courses #courseGrid .wd-course-card .wd-equip-card-body h3{min-height:42px!important}.whaledive-courses #courseGrid .wd-course-card .wd-equip-actions .wd-mini-link{min-width:112px!important;justify-content:center!important}@media(max-width:980px){.whaledive-courses #courseGrid.wd-page-grid{grid-template-columns:repeat(2,minmax(0,1fr))!important}}@media(max-width:620px){
  ...
  .whaledive-courses #courseFilters{width:100%!important;max-width:100%!important;display:flex!important;flex-wrap:wrap!important;justify-content:center!important;gap:8px!important;overflow:visible!important;margin-left:0!important;margin-right:0!important}
...
<main class="wd-page">
  ...
  <section class="wd-inner-hero wd-courses-hero"><div class="wd-shell wd-inner-grid"><div><span class="wd-kicker"><?php echo esc_html(contenly_tr('Dive training support', 'Dive training support')); ?></span><h1><?php echo esc_html(contenly_tr('Courses that fit your next dive, not just your calendar.', 'Courses that fit your next dive, not just your calendar.')); ?></h1><p><?php echo esc_html(contenly_tr('Browse certification pathways, check pricing, and get crew guidance before choosing your next course.', 'Browse certification pathways, check pricing, and get crew guidance before choosing your next course.')); ?></p><div class="wd-actions"><a class="wd-btn" href="/contact/"><?php echo esc_html(contenly_tr('Ask Course Plan', 'Ask Course Plan')); ?></a><a class="wd-btn alt" href="#course-catalog"><?php echo esc_html(contenly_tr('Browse Courses', 'Browse Courses')); ?></a></div></div><aside class="wd-inner-card"><b><?php echo esc_html(contenly_tr('Training support covers', 'Training support covers')); ?></b><ul><li>Certification pathway checks</li><li>Small-group coaching guidance</li><li>Gear and schedule readiness</li><li>PADI / SSI / NAUI / TDI options</li></ul></aside></div></section>

  <section id="course-catalog" class="wd-section white wd-center">
    <div class="wd-shell">
      <span class="wd-kicker">Course catalog</span>
      <h2 class="wd-title"><?php echo esc_html(contenly_tr('Dive courses from trusted agencies', 'Dive courses from trusted agencies')); ?></h2>
      ...
      <div id="courseFilters" class="wd-filter-bar">
        <button class="wd-chip active" data-filter="all"><?php echo esc_html(contenly_tr('All Courses', 'All Courses')); ?></button>
  ...
  <section class="wdc-card-cta"><div class="wd-shell"><span class="wd-kicker">Need course advice?</span><h2><?php echo esc_html(contenly_tr('The crew helps you choose the right path.', 'The crew helps you choose the right path.')); ?></h2><p>Tell us your certification level, target dates, and comfort goals — we recommend the course that fits.</p><a class="wd-btn alt" href="/contact/"><?php echo esc_html(contenly_tr('Ask About Course Plan', 'Ask About Course Plan')); ?></a></div></section>
