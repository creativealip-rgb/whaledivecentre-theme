...
<main class="wd-page">
  ...
  <?php
    $wdc_courses_cta_kicker = function_exists('wdc_site_get') ? wdc_site_tr('courses_page_cta_kicker', 'Butuh saran kursus?', 'Need course advice?') : contenly_tr('Butuh saran kursus?', 'Need course advice?');
    $wdc_courses_cta_title = function_exists('wdc_site_get') ? wdc_site_tr('courses_page_cta_title', 'Crew bantu pilih jalur yang tepat.', 'The crew helps you choose the right path.') : contenly_tr('Crew bantu pilih jalur yang tepat.', 'The crew helps you choose the right path.');
    $wdc_courses_cta_text = function_exists('wdc_site_get') ? wdc_site_tr('courses_page_cta_text', 'Ceritakan level sertifikasi, target tanggal, dan tujuan kenyamanan — kami rekomendasikan kursus yang cocok.', 'Tell us your certification level, target dates, and comfort goals — we recommend the course that fits.') : contenly_tr('Ceritakan level sertifikasi, target tanggal, dan tujuan kenyamanan — kami rekomendasikan kursus yang cocok.', 'Tell us your certification level, target dates, and comfort goals — we recommend the course that fits.');
    $wdc_courses_cta_label = function_exists('wdc_site_get') ? wdc_site_tr('courses_page_cta_label', 'Tanya Rencana Kursus', 'Ask About Course Plan') : contenly_tr('Tanya Rencana Kursus', 'Ask About Course Plan');
