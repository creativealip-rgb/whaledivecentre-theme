...
.whaledive-courses #courseGrid.wd-page-grid{grid-template-columns:repeat(3,minmax(0,1fr))!important;gap:16px!important}.whaledive-courses #courseGrid .wd-course-card .wd-equip-card-body h3{min-height:42px!important}.whaledive-courses #courseGrid .wd-course-card .wd-equip-actions .wd-mini-link{min-width:112px!important;justify-content:center!important}@media(max-width:980px){.whaledive-courses #courseGrid.wd-page-grid{grid-template-columns:repeat(2,minmax(0,1fr))!important}}@media(max-width:620px){
  ...
  .whaledive-courses h1{width:100%!important;max-width:100%!important;font-size:var(--wdc-page-h1,clamp(28px,7.5vw,34px))!important;line-height:1.1!important;letter-spacing:-.03em!important;white-space:normal!important;overflow-wrap:break-word!important;word-break:normal!important}.whaledive-courses .wd-title,.whaledive-courses h2{width:100%!important;max-width:100%!important;font-size:var(--wdc-section-h2,clamp(22px,6vw,26px))!important;line-height:1.15!important;letter-spacing:-.025em!important;white-space:normal!important;overflow-wrap:break-word!important;word-break:normal!important}
  ...
  .whaledive-courses .wd-inner-hero h1,.whaledive-courses .wd-inner-copy h1{font-size:var(--wdc-page-h1,clamp(28px,7.5vw,34px))!important;line-height:1.1!important;letter-spacing:-.03em!important;width:calc(100% - 10px)!important;max-width:calc(100% - 10px)!important;margin-right:10px!important;display:block!important;white-space:normal!important;overflow-wrap:break-word!important;word-break:normal!important}
  ...
  .whaledive-courses .wdc-card-cta h2{font-size:var(--wdc-section-h2,clamp(22px,6vw,26px))!important;line-height:1.15!important;width:100%!important;max-width:100%!important;white-space:normal!important;overflow-wrap:break-word!important}
  ...
  body.whaledive-courses .wd-courses-hero h1{font-size:var(--wdc-page-h1,clamp(28px,7.5vw,34px))!important;line-height:1.1!important;letter-spacing:-.03em!important;width:100%!important;max-width:100%!important;margin-left:0!important;margin-right:0!important;white-space:normal!important;overflow-wrap:break-word!important;word-break:normal!important}
...
<main class="wd-page">
          ...
          <article class="wd-equip-card wd-detail-card wd-shop-card wd-course-card" data-href="<?php echo esc_url($permalink); ?>" data-cat="cat-<?php echo esc_attr($level_slug); ?>" style="border-radius:18px!important;overflow:hidden!important;padding:0!important;background:#fff!important;box-shadow:0 14px 34px rgba(2,21,43,.07)!important;border:1px solid rgba(6,56,77,.08)!important;min-height:0!important;height:auto!important;display:flex!important;flex-direction:column!important;">
            ...
            <div class="wd-equip-card-body" style="padding:16px!important;min-height:0!important;height:auto!important;display:flex!important;flex-direction:column!important;gap:6px!important;background:#fff!important;">
              ...
              <div class="wd-equip-price" style="display:flex!important;flex-direction:column!important;align-items:flex-start!important;gap:4px!important;margin:0 0 6px!important;padding:0!important;background:transparent!important;border:0!important;">
                ...
                <span class="wd-price-amount" style="display:block!important;width:100%!important;flex-basis:100%!important;color:#004A98!important;font-size:17px!important;line-height:1.1!important;font-weight:950!important;letter-spacing:-.02em!important;">Rp <?php echo number_format((float)$price,0,',','.'); ?></span>
              </div>
              <?php endif; ?>
              <div class="wd-equip-chips" style="gap:6px!important;margin:0 0 4px!important;display:flex!important;flex-wrap:wrap!important;">
                <?php if($duration): ?><span style="padding:5px 8px!important;border-radius:999px!important;background:rgba(150,218,234,.22)!important;color:#35586a!important;font-size:10px!important;font-weight:800!important;line-height:1!important;"><?php echo esc_html($duration); ?></span><?php endif; ?>
                <span style="padding:5px 8px!important;border-radius:999px!important;background:rgba(150,218,234,.22)!important;color:#35586a!important;font-size:10px!important;font-weight:800!important;line-height:1!important;"><?php echo $max_students ? contenly_tr('Maks ', 'Max ') . esc_html($max_students) . contenly_tr(' diver', ' divers') : contenly_tr('Cek ketersediaan', 'Check availability'); ?></span>
                <?php if($prereqs): ?><span class="wd-course-prereq-chip" style="padding:5px 8px!important;border-radius:999px!important;background:rgba(150,218,234,.22)!important;color:#35586a!important;font-size:10px!important;font-weight:800!important;line-height:1!important;"><?php echo contenly_tr('Prasyarat: ', 'Prereq: '); ?><?php echo esc_html($prereqs); ?></span><?php endif; ?>
              </div>
              <div class="wd-equip-actions" style="margin-top:8px!important;padding-top:0!important;border-top:0!important;display:flex!important;gap:8px!important;flex-wrap:wrap!important;">
                <a class="wd-mini-link" style="min-height:38px!important;min-width:100px!important;justify-content:center!important;width:max-content!important;margin:0!important;padding:0 16px!important;border-radius:999px!important;font-size:13px!important;font-weight:900!important;background:rgba(150,218,234,.22)!important;border:1px solid rgba(6,56,77,.14)!important;color:#004A98!important;box-shadow:none!important;display:inline-flex!important;align-items:center!important;text-decoration:none!important;" href="<?php echo esc_url($permalink); ?>"><?php echo contenly_tr('Lihat Detail', 'View Details'); ?></a>
                <a class="wd-mini-btn" onclick="event.stopPropagation();" style="min-height:38px!important;min-width:100px!important;justify-content:center!important;width:max-content!important;margin:0!important;padding:0 16px!important;border-radius:999px!important;font-size:13px!important;font-weight:900!important;background:#004A98!important;border:1px solid #004A98!important;color:#fff!important;box-shadow:none!important;display:inline-flex!important;align-items:center!important;text-decoration:none!important;" href="<?php echo esc_url(wdc_member_action_url('course', $course->ID, $course->post_title)); ?>"><?php echo contenly_tr('Daftar', 'Enroll'); ?></a>
              </div>
            </div>
          </article>
          <?php endforeach; ?>
  ...
  <?php
    $wdc_courses_cta_kicker = function_exists('wdc_site_get') ? wdc_site_get('courses_page_cta_kicker', contenly_tr('Butuh saran kursus?', 'Need course advice?')) : contenly_tr('Butuh saran kursus?', 'Need course advice?');
    $wdc_courses_cta_title = function_exists('wdc_site_get') ? wdc_site_get('courses_page_cta_title', contenly_tr('Crew bantu pilih jalur yang tepat.', 'The crew helps you choose the right path.')) : contenly_tr('Crew bantu pilih jalur yang tepat.', 'The crew helps you choose the right path.');
    $wdc_courses_cta_text = function_exists('wdc_site_get') ? wdc_site_get('courses_page_cta_text', contenly_tr('Ceritakan level sertifikasi, target tanggal, dan tujuan kenyamanan — kami rekomendasikan kursus yang cocok.', 'Tell us your certification level, target dates, and comfort goals — we recommend the course that fits.')) : contenly_tr('Ceritakan level sertifikasi, target tanggal, dan tujuan kenyamanan — kami rekomendasikan kursus yang cocok.', 'Tell us your certification level, target dates, and comfort goals — we recommend the course that fits.');
    $wdc_courses_cta_label = function_exists('wdc_site_get') ? wdc_site_get('courses_page_cta_label', contenly_tr('Tanya Rencana Kursus', 'Ask About Course Plan')) : contenly_tr('Tanya Rencana Kursus', 'Ask About Course Plan');
    $wdc_courses_cta_url = function_exists('wdc_site_url') ? wdc_site_url(wdc_site_get('courses_page_cta_url', '/contact/')) : home_url('/contact/');
  ?>
  <section class="wdc-card-cta"><div class="wd-shell"><span class="wd-kicker"><?php echo esc_html($wdc_courses_cta_kicker); ?></span><h2><?php echo esc_html($wdc_courses_cta_title); ?></h2><p><?php echo esc_html($wdc_courses_cta_text); ?></p><a class="wd-btn alt" href="<?php echo esc_url($wdc_courses_cta_url); ?>"><?php echo esc_html($wdc_courses_cta_label); ?></a></div></section>
