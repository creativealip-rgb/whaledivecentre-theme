    ...
    <div class="wd-shell" style="max-width:640px;">
        ...
        <div style="background:#fff;border-radius:24px;padding:40px;box-shadow:0 20px 60px rgba(2,21,43,.08);border:1px solid rgba(6,56,77,.06);">
            ...
            <div style="background: #f0f9ff; border-radius: 12px; padding: 24px; margin-bottom: 32px;">
                <h2 style="font-size: 18px; font-weight: 600; color: #0f172a; margin-bottom: 16px; letter-spacing: .03em;"><?php echo esc_html(contenly_tr('Detail Booking', 'Booking Details')); ?></h2>
            ...
            <div style="margin-bottom: 32px;">
                <h2 style="font-size: 18px; font-weight: 600; color: #0f172a; margin-bottom: 16px; letter-spacing: .03em;"><?php echo esc_html(contenly_tr('Instruksi Pembayaran', 'Payment Instructions')); ?></h2>
            ...
            <div id="payment-success" style="display: none; text-align: center; padding: 32px;">
                ...
                <h2 style="font-size: 24px; font-weight: 700; color: #0f172a; margin-bottom: 8px; letter-spacing: .03em;"><?php echo esc_html(contenly_tr('Bukti Pembayaran Berhasil Diupload!', 'Payment Uploaded!')); ?></h2>
