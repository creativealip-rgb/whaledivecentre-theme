...
<main class="wd-page">
    ...
    <div class="wd-shell">
      <div class="wd-inner-grid">
        <div>
          ...
          <p><?php echo esc_html(contenly_tr('Didirikan pada 2009 di Jakarta, WDC berfokus pada pendidikan penyelam, keselamatan, eksplorasi bawah laut, dan pengembangan profesional diving Indonesia.', 'Founded in 2009 in Jakarta, WDC focuses on diver education, safety, underwater exploration, and professional development for Indonesia’s diving community.')); ?></p>
  ...
  <section class="wd-section white wdc-about-v2-intro">
    <div class="wd-shell">
      <div class="wd-about-split">
        <div>
          <span class="wd-kicker"><?php echo esc_html(contenly_tr('Sejak 2009', 'Since 2009')); ?></span>
        ...
        <div class="wd-about-stat-grid">
          <div><strong>2009</strong><span><?php echo esc_html(contenly_tr('Didirikan di Jakarta', 'Founded in Jakarta')); ?></span></div>
  ...
  <section class="wd-section wd-dark">
    <div class="wd-shell">
      <span class="wd-kicker"><?php echo esc_html(contenly_tr('Fokus Kami', 'Our Focus')); ?></span>
      <h2 class="wd-title"><?php echo esc_html(contenly_tr('Dari first dive sampai level profesional.', 'From first dive to professional level.')); ?></h2>
      <div class="wd-safety-grid"><article><b><?php echo esc_html(contenly_tr('Pelatihan rekreasional', 'Recreational training')); ?></b><span><?php echo esc_html(contenly_tr('Membangun fondasi skill, buoyancy, buddy awareness, dan confidence untuk diver baru.', 'Build core skills, buoyancy, buddy awareness, and confidence for new divers.')); ?></span></article><article><b><?php echo esc_html(contenly_tr('Pelatihan profesional', 'Professional training')); ?></b><span><?php echo esc_html(contenly_tr('Mengembangkan leadership, briefing, rescue awareness, dan standar kerja profesional.', 'Develop leadership, briefing, rescue awareness, and professional working standards.')); ?></span></article><article><b><?php echo esc_html(contenly_tr('Technical & safety culture', 'Technical & safety culture')); ?></b><span><?php echo esc_html(contenly_tr('Mendorong perencanaan konservatif, disiplin prosedur, dan keputusan yang sadar risiko.', 'Promote conservative planning, procedural discipline, and risk-aware decisions.')); ?></span></article></div>
    </div>
  </section>
