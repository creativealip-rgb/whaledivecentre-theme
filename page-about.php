...
<main class="wd-page">
  ...
  <section class="wd-inner-hero wd-about-hero">
    <div class="wd-shell">
      <div class="wd-inner-grid">
        <div>
          <span class="wd-kicker"><?php echo esc_html(contenly_tr('About Whale Dive Centre', 'About Whale Dive Centre')); ?></span>
          <h1><?php echo esc_html(contenly_tr('Calm training. Better habits. Safer dives.', 'Calm training. Better habits. Safer dives.')); ?></h1>
          <p><?php echo esc_html(contenly_tr('A Jakarta-based dive centre focused on professional scuba training, quality gear support, and an ocean-minded community.', 'A Jakarta-based dive centre focused on professional scuba training, quality gear support, and an ocean-minded community.')); ?></p><div class="wd-actions"><a class="wd-btn" href="#contact-form"><?php echo esc_html(contenly_tr('Start Inquiry', 'Start Inquiry')); ?></a><a class="wd-btn alt" href="/courses/"><?php echo esc_html(contenly_tr('View Courses', 'View Courses')); ?></a></div>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="wd-section white wd-team-standards">
    <div class="wd-shell">
      ...
      <h2 class="wd-title"><?php echo esc_html(contenly_tr('Crew-led standards for safer dive days', 'Crew-led standards for safer dive days')); ?></h2>
  ...
  <section class="wd-section white" id="contact-form">
    <div class="wd-shell">
      ...
      <h2 class="wd-title"><?php echo esc_html(contenly_tr('Start the conversation', 'Start the conversation')); ?></h2>
...
<div class="wd-contact-card"><strong>Email</strong><a href="mailto:info@whaledivecentre.com">info@whaledivecentre.com</a></div>
        ...
        <form class="wd-contact-form" method="post">
          ...
          <p class="wd-form-privacy">We only use your contact details to reply to this inquiry.</p><button type="submit" class="wd-btn"><?php echo esc_html(contenly_tr('Send Inquiry', 'Send Inquiry')); ?></button>
        </form>
      </div>
    </div>
  </section>

  <footer id="contact" class="wd-footer"><div class="wd-shell"><div class="wd-footer-top"><div class="wd-footer-brand"><span class="wd-footer-kicker">Ready to dive?</span><h2>Whale Dive Centre</h2><p>Dive training, community trips, equipment support, and ocean-minded experiences for safer adventures below the surface.</p><a class="wd-btn alt" href="/contact/"><?php echo esc_html(contenly_tr('Start Inquiry', 'Start Inquiry')); ?></a></div><nav class="wd-footer-col"><h3>Explore</h3><a href="/courses/">Dive Courses</a><a href="/equipment/">Scuba Equipment</a><a href="/about/">About Us</a><a href="/blog/">Blog</a></nav><nav class="wd-footer-col"><h3>Courses</h3><a href="/course/open-water-diver/">Open Water</a><a href="/course/advanced-open-water/">Advanced Open Water</a><a href="/course/rescue-diver/">Rescue Diver</a><a href="/course/divemaster/">Divemaster</a><a href="/course/instructor-course/">Instructor</a></nav><div class="wd-footer-col"><h3>Contact</h3><p>Email: info@whaledivecentre.com</p><p>WhatsApp: <?php echo esc_html(get_option("wdc_whatsapp_number", "(021) 27939068")); ?></p><p>Jl. Tanah Kusir II No.3, RT.10/RW.9, Kby. Lama Sel., Kec. Kebayoran Lama, Kota Jakarta Selatan, DKI Jakarta 12240</p><div class="wd-social"><a href="https://www.instagram.com/whaledivecentre.id?igsh=YjE1Z3o4NjBmcjAy" target="_blank" rel="noopener" aria-label="Instagram">Instagram</a></div></div></div><div class="wd-footer-bottom"><span>© <?php echo date('Y'); ?> Whale Dive Centre. All rights reserved.</span><span>PADI / SSI / NAUI / TDI training pathways</span></div></div></footer>
</main>
