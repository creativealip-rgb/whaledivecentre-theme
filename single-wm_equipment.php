...
<main class="wd-page">
    ...
    <div class="wd-shell wd-content-grid">
      <div class="wd-content-main">
        ...
        <div class="wd-gear-service-grid">
          <article><b><?php echo contenly_tr('Panduan ukuran', 'Fit guidance'); ?></b><span><?php echo contenly_tr('Tanyakan ke tim tentang seal mask, ukuran BCD, perlindungan exposure, dan kenyamanan sebelum membeli.', 'Ask the crew about mask seal, BCD size, exposure protection, and comfort before buying.'); ?></span></article>
          <article><b><?php echo contenly_tr('Siap untuk pelatihan', 'Training-ready setup'); ?></b><span><?php echo contenly_tr('Direkomendasikan untuk sesi kursus, fun dive, dan membangun kebiasaan lebih aman.', 'Recommended for course sessions, fun dives, and safer habit-building.'); ?></span></article>
          <article><b><?php echo contenly_tr('Cek ketersediaan', 'Availability check'); ?></b><span><?php echo contenly_tr('Stok dan ukuran bisa berubah; konfirmasi sebelum checkout atau pengambilan.', 'Stock and sizing can change; confirm before checkout or pickup.'); ?></span></article>
        </div>
      </div>
  ...
  <footer id="contact" class="wd-footer"><div class="wd-shell"><div class="wd-footer-top"><div class="wd-footer-brand"><span class="wd-footer-kicker"><?php echo contenly_tr('Siap menyelam?', 'Ready to dive?'); ?></span><h2>Whale Dive Centre</h2><p><?php echo contenly_tr('Pelatihan menyelam, perjalanan komunitas, dukungan peralatan, dan pengalaman berwawasan laut untuk petualangan lebih aman di bawah permukaan.', 'Dive training, community trips, equipment support, and ocean-minded experiences for safer adventures below the surface.'); ?></p><a class="wd-btn alt" href="<?php echo esc_url(home_url('/contact/')); ?>"><?php echo contenly_tr('Mulai Konsultasi', 'Start Inquiry'); ?></a></div><nav class="wd-footer-col"><h3><?php echo contenly_tr('Jelajahi', 'Explore'); ?></h3><a href="<?php echo esc_url(home_url('/courses/')); ?>"><?php echo contenly_tr('Kursus Menyelam', 'Dive Courses'); ?></a><a href="<?php echo esc_url(home_url('/equipment/')); ?>"><?php echo contenly_tr('Peralatan Selam', 'Scuba Equipment'); ?></a><a href="<?php echo esc_url(home_url('/about/')); ?>"><?php echo contenly_tr('Tentang Kami', 'About Us'); ?></a><a href="<?php echo esc_url(home_url('/blog/')); ?>">Blog</a></nav><nav class="wd-footer-col"><h3><?php echo contenly_tr('Kursus', 'Courses'); ?></h3><a href="<?php echo esc_url(home_url('/courses/open-water-scuba-diver/')); ?>">Open Water</a><a href="<?php echo esc_url(home_url('/courses/advanced-open-water-diver/')); ?>">Advanced Open Water</a><a href="<?php echo esc_url(home_url('/courses/rescue-scuba-diver/')); ?>">Rescue Diver</a><a href="<?php echo esc_url(home_url('/courses/divemaster/')); ?>">Divemaster</a><a href="<?php echo esc_url(home_url('/courses/instructor/')); ?>">Instructor</a><a href="<?php echo esc_url(home_url('/courses/intro-to-tech/')); ?>">Technical Diver</a><a href="<?php echo esc_url(home_url('/courses/')); ?>"><?php echo contenly_tr('Lihat Semua Kursus', 'See All Courses'); ?></a></nav><div class="wd-footer-col"><h3><?php echo contenly_tr('Kontak', 'Contact'); ?></h3><p>Email: info@whaledivecentre.com</p><p>Telepon: (021) 27939068</p><p>Jl. Tanah Kusir II No.3, Kebayoran Lama, Jakarta Selatan 12240</p><div class="wd-social"><a href="https://www.instagram.com/whaledivecentre.id/" target="_blank" rel="noopener" aria-label="Instagram"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg></a><a href="https://www.facebook.com/whaledivecentre" target="_blank" rel="noopener" aria-label="Facebook"><svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg></a><a href="https://x.com/whaledivecentre" target="_blank" rel="noopener" aria-label="X (Twitter)"><svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg></a></div></div></div><div class="wd-footer-bottom"><span>&copy; <?php echo date('Y'); ?> Whale Dive Centre. <?php echo contenly_tr('Hak cipta dilindungi.', 'All rights reserved.'); ?></span><span>NAUI / TDI / DAN training pathways</span></div></div></footer>
</main>
...
document.addEventListener('DOMContentLoaded', function(){
  document.querySelectorAll('.wd-equipment-add-cart').forEach(function(btn){
    btn.addEventListener('click', function(){
      if (!window.wmCart || !wmCart.addToCart) { window.location.href = '<?php echo esc_js(home_url('/direct-checkout/')); ?>'; return; }
      ...
      wmCart.addToCart('equipment', btn.getAttribute('data-item-id'), 1, {}).then(function(data){
        if (data && data.success) { window.location.href = '<?php echo esc_js(home_url('/direct-checkout/')); ?>'; return; }
        btn.disabled = false;
