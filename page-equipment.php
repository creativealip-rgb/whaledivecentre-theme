...
<main class="wd-page">
  ...
  <?php
    $wdc_equip_cta_kicker = function_exists('wdc_site_get') ? wdc_site_tr('equip_page_cta_kicker', 'Butuh saran gear?', 'Need gear advice?') : contenly_tr('Butuh saran gear?', 'Need gear advice?');
    $wdc_equip_cta_title = function_exists('wdc_site_get') ? wdc_site_tr('equip_page_cta_title', 'Crew bantu cari yang pas.', 'The crew helps you find the right fit.') : contenly_tr('Crew bantu cari yang pas.', 'The crew helps you find the right fit.');
    $wdc_equip_cta_text = function_exists('wdc_site_get') ? wdc_site_tr('equip_page_cta_text', 'Ceritakan level sertifikasi, rencana dive, dan budget — kami rekomendasikan gear yang cocok.', 'Tell us your certification level, dive plans, and budget — we recommend gear that works.') : contenly_tr('Ceritakan level sertifikasi, rencana dive, dan budget — kami rekomendasikan gear yang cocok.', 'Tell us your certification level, dive plans, and budget — we recommend gear that works.');
    $wdc_equip_cta_label = function_exists('wdc_site_get') ? wdc_site_tr('equip_page_cta_label', 'Ajukan via Member', 'Request as Member') : contenly_tr('Ajukan via Member', 'Request as Member');
