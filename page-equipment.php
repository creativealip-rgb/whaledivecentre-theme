...
</style><style id="wdc-equip-full-bleed">/* WDC EQUIP FULL BLEED */.whaledive-equipment article.wd-shop-card .wd-equip-visual,.whaledive-equipment article.wd-shop-card .wd-equip-visual.has-photo,.whaledive-equipment #equipGrid .wd-equip-visual,.whaledive-equipment #equipGrid .wd-equip-visual.has-photo{padding:0!important;border:0!important;border-bottom:0!important;background:transparent!important;background-image:none!important;box-shadow:none!important;min-height:0!important;height:190px!important;overflow:hidden!important;position:relative!important}.whaledive-equipment article.wd-shop-card .wd-equip-visual:before,.whaledive-equipment article.wd-shop-card .wd-equip-visual:after,.whaledive-equipment #equipGrid .wd-equip-visual:before,.whaledive-equipment #equipGrid .wd-equip-visual:after{content:none!important;display:none!important}.whaledive-equipment article.wd-shop-card .wd-equip-photo,.whaledive-equipment #equipGrid .wd-equip-photo{position:absolute!important;inset:0!important;width:100%!important;height:100%!important;padding:0!important;margin:0!important;border:0!important;object-fit:cover!important;object-position:center!important;background:transparent!important;transform:none!important;z-index:1!important}.whaledive-equipment article.wd-shop-card .wd-equip-type,.whaledive-equipment #equipGrid .wd-equip-type{z-index:2!important}@media(max-width:540px){.whaledive-equipment .wd-shop-card .wd-equip-visual,.whaledive-equipment #equipGrid .wd-equip-visual{height:100%!important;min-height:178px!important}}</style>
</head>
<body <?php body_class('whaledive-inner whaledive-equipment'); ?>><?php wp_body_open(); ?>
<main class="wd-page">
  <?php contenly_render_public_header(); ?>

  <section class="wd-inner-hero wd-equipment-hero"><div class="wd-shell wd-inner-grid"><div><span class="wd-kicker"><?php echo esc_html(contenly_tr('Dukungan peralatan selam', 'Scuba gear support')); ?></span><h1><?php echo esc_html(contenly_tr('Peralatan yang sesuai dengan dive, bukan hanya keranjang Anda.', 'Equipment that fits your dive, not just your cart.')); ?></h1><p><?php echo esc_html(contenly_tr('Jelajahi gear berdasarkan kategori, cek harga, dan dapatkan panduan crew sebelum membeli atau menyewa.', 'Browse gear by category, check pricing, and get crew guidance before buying or renting.')); ?></p><div class="wd-actions"><a class="wd-btn" href="<?php echo esc_url(function_exists('wdc_site_url') ? wdc_site_url(wdc_site_get('equip_hero_cta_url', '/contact/')) : home_url('/contact/')); ?>"><?php echo esc_html(function_exists('wdc_site_get') ? wdc_site_get('equip_hero_cta_label', contenly_tr('Tanya Ketersediaan', 'Ask Availability')) : contenly_tr('Tanya Ketersediaan', 'Ask Availability')); ?></a><a class="wd-btn alt" href="#equipment-catalog"><?php echo esc_html(contenly_tr('Lihat Peralatan', 'Browse Gear')); ?></a></div></div><aside class="wd-inner-card"><b><?php echo esc_html(contenly_tr('Dukungan gear mencakup', 'Gear support covers')); ?></b><ul><li><?php echo esc_html(contenly_tr('Pemeriksaan pas dan kenyamanan', 'Fit and comfort checks')); ?></li><li><?php echo esc_html(contenly_tr('Rekomendasi siap latihan', 'Training-ready recommendations')); ?></li><li><?php echo esc_html(contenly_tr('Panduan beli atau sewa', 'Buy or rent guidance')); ?></li><li><?php echo esc_html(contenly_tr('Hanya brand terpercaya', 'Trusted brands only')); ?></li></ul></aside></div></section>
        ...
        <article class="wd-equip-card wd-detail-card wd-shop-card" data-href="<?php echo esc_url($permalink); ?>" onclick="if(!event.target.closest('a,button')){window.location.href=this.dataset.href;}" data-cat="cat-<?php echo esc_attr($cat_slug); ?>" style="border-radius:18px!important;overflow:hidden!important;padding:0!important;background:#fff!important;box-shadow:0 14px 34px rgba(2,21,43,.07)!important;border:1px solid rgba(6,56,77,.08)!important;min-height:0!important;height:auto!important;display:flex!important;flex-direction:column!important;">
          ...
          <div class="wd-equip-card-body" style="padding:16px!important;min-height:0!important;height:auto!important;display:flex!important;flex-direction:column!important;gap:6px!important;background:#fff!important;">
            ...
            <div class="wd-equip-chips" style="gap:6px!important;margin:0 0 4px!important;display:flex!important;flex-wrap:wrap!important;">
              <?php if($sizes): ?><span style="padding:5px 8px!important;border-radius:999px!important;background:rgba(150,218,234,.22)!important;color:#35586a!important;font-size:10px!important;font-weight:800!important;line-height:1!important;"><?php echo contenly_tr('Ukuran: ', 'Sizes: '); ?><?php echo esc_html($sizes); ?></span><?php endif; ?>
            ...
            <div class="wd-equip-actions" style="margin-top:8px!important;padding-top:0!important;border-top:0!important;display:flex!important;gap:8px!important;flex-wrap:wrap!important;">
              ...
              <a class="wd-mini-btn" onclick="event.stopPropagation();" style="min-height:38px!important;min-width:100px!important;justify-content:center!important;width:max-content!important;margin:0!important;padding:0 16px!important;border-radius:999px!important;font-size:13px!important;font-weight:900!important;background:#004A98!important;border:1px solid #004A98!important;color:#fff!important;box-shadow:none!important;display:inline-flex!important;align-items:center!important;text-decoration:none!important;" href="<?php echo esc_url(wdc_member_action_url('equipment', $item->ID, $item->post_title)); ?>"><?php echo contenly_tr('Beli', 'Buy'); ?></a>
            </div>
          </div>
        </article>
        <?php endforeach; ?>
  ...
  <?php
    $wdc_equip_cta_kicker = function_exists('wdc_site_get') ? wdc_site_get('equip_page_cta_kicker', contenly_tr('Butuh saran gear?', 'Need gear advice?')) : contenly_tr('Butuh saran gear?', 'Need gear advice?');
    $wdc_equip_cta_title = function_exists('wdc_site_get') ? wdc_site_get('equip_page_cta_title', contenly_tr('Crew bantu cari yang pas.', 'The crew helps you find the right fit.')) : contenly_tr('Crew bantu cari yang pas.', 'The crew helps you find the right fit.');
    $wdc_equip_cta_text = function_exists('wdc_site_get') ? wdc_site_get('equip_page_cta_text', contenly_tr('Ceritakan level sertifikasi, rencana dive, dan budget — kami rekomendasikan gear yang cocok.', 'Tell us your certification level, dive plans, and budget — we recommend gear that works.')) : contenly_tr('Ceritakan level sertifikasi, rencana dive, dan budget — kami rekomendasikan gear yang cocok.', 'Tell us your certification level, dive plans, and budget — we recommend gear that works.');
    $wdc_equip_cta_label = function_exists('wdc_site_get') ? wdc_site_get('equip_page_cta_label', contenly_tr('Ajukan via Member', 'Request as Member')) : contenly_tr('Ajukan via Member', 'Request as Member');
    $wdc_equip_cta_url_raw = function_exists('wdc_site_get') ? trim((string) wdc_site_get('equip_page_cta_url', '')) : '';
    if ($wdc_equip_cta_url_raw === '') {
      $wdc_equip_cta_url = function_exists('wdc_member_action_url') ? wdc_member_action_url('equipment') : home_url('/login/');
    } else {
      $wdc_equip_cta_url = function_exists('wdc_site_url') ? wdc_site_url($wdc_equip_cta_url_raw) : home_url($wdc_equip_cta_url_raw);
    }
  ?>
  <section class="wdc-card-cta"><div class="wd-shell"><span class="wd-kicker"><?php echo esc_html($wdc_equip_cta_kicker); ?></span><h2><?php echo esc_html($wdc_equip_cta_title); ?></h2><p><?php echo esc_html($wdc_equip_cta_text); ?></p><a class="wd-btn alt" href="<?php echo esc_url($wdc_equip_cta_url); ?>"><?php echo esc_html($wdc_equip_cta_label); ?></a></div></section>

    <?php contenly_render_public_footer(); ?>
<script>/* catalog add cart */document.addEventListener('DOMContentLoaded',function(){document.querySelectorAll('.wd-equipment-add-cart').forEach(function(btn){btn.addEventListener('click',function(){if(!window.wmCart||!wmCart.addToCart){window.location.href='/direct-checkout/';return;}var original=btn.textContent;btn.disabled=true;btn.textContent='Adding...';wmCart.addToCart('equipment',btn.getAttribute('data-item-id'),1,{}).then(function(data){if(data&&data.success){window.location.href='/direct-checkout/';return;}btn.disabled=false;btn.textContent=original;}).catch(function(){btn.disabled=false;btn.textContent=original;});});});});</script>
</main>
