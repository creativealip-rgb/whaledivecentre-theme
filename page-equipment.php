...
<main class="wd-page">
  ...
  <section class="wd-inner-hero wd-equipment-hero"><div class="wd-shell wd-inner-grid"><div><span class="wd-kicker"><?php echo esc_html(contenly_tr('Scuba gear support', 'Scuba gear support')); ?></span><h1><?php echo esc_html(contenly_tr('Equipment that fits your dive, not just your cart.', 'Equipment that fits your dive, not just your cart.')); ?></h1><p><?php echo esc_html(contenly_tr('Browse gear by category, check pricing, and get crew guidance before buying or renting.', 'Browse gear by category, check pricing, and get crew guidance before buying or renting.')); ?></p><div class="wd-actions"><a class="wd-btn" href="/contact/"><?php echo esc_html(contenly_tr('Ask Availability', 'Ask Availability')); ?></a><a class="wd-btn alt" href="#equipment-catalog"><?php echo esc_html(contenly_tr('Browse Gear', 'Browse Gear')); ?></a></div></div><aside class="wd-inner-card"><b><?php echo esc_html(contenly_tr('Gear support covers', 'Gear support covers')); ?></b><ul><li>Fit and comfort checks</li><li>Training-ready recommendations</li><li>Buy or rent guidance</li><li>Trusted brands only</li></ul></aside></div></section>

  <section id="equipment-catalog" class="wd-section white wd-center">
    <div class="wd-shell">
      <span class="wd-kicker">Equipment catalog</span>
      <h2 class="wd-title"><?php echo esc_html(contenly_tr('Dive gear from trusted brands', 'Dive gear from trusted brands')); ?></h2>
      ...
      <div id="equipFilters" class="wd-filter-bar">
        <button class="wd-chip active" data-filter="all"><?php echo esc_html(contenly_tr('All Gear', 'All Gear')); ?></button>
  ...
  <section class="wdc-card-cta"><div class="wd-shell"><span class="wd-kicker">Need gear advice?</span><h2><?php echo esc_html(contenly_tr('The crew helps you find the right fit.', 'The crew helps you find the right fit.')); ?></h2><p>Tell us your certification level, dive plans, and budget — we recommend gear that works.</p><a class="wd-btn alt" href="/contact/"><?php echo esc_html(contenly_tr('Ask About Gear Fit', 'Ask About Gear Fit')); ?></a></div></section>
