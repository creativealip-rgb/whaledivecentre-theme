...
<head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><?php wp_head(); ?><style id="wd-blog-ux-pass">.wd-blog-search{display:flex;gap:10px;margin:0 0 14px}.wd-blog-search input{flex:1;min-height:50px;border:1px solid #d8e8e8;border-radius:999px;padding:0 18px}.wd-blog-search button{border:0;border-radius:999px;padding:0 22px;background:#004A98;color:#fff;font-weight:800}.wd-topic-pills{display:flex;gap:9px;flex-wrap:wrap;margin-bottom:22px}.wd-topic-pills a{display:inline-flex;align-items:center;min-height:38px;padding:0 13px;border-radius:999px;background:rgba(150,218,234,.22);color:#0b617c;text-decoration:none;font-weight:800;font-size:13px}.wd-blog-cta{display:flex;gap:12px;align-items:center;flex-wrap:wrap;margin:0 0 28px;padding:18px;border-radius:22px;background:linear-gradient(135deg,#06384d,#08a7c7);color:#fff}.wd-blog-cta span{color:rgba(255,255,255,.78)}.wd-blog-cta a{margin-left:auto;color:#004A98;background:#fff;border-radius:999px;padding:10px 14px;text-decoration:none;font-weight:900}@media(max-width:640px){.wd-blog-search{display:grid}.wd-blog-cta a{width:100%;text-align:center}}</style><style id="wd-blog-header-readable-critical">
...
.whaledive-blog .wd-blog-section-clean:before{content:"";position:absolute;inset:0 0 auto;height:520px;background:linear-gradient(180deg,rgba(2,15,32,.18),rgba(2,15,32,.56)),url('https://whaledivecentre.com/wp-content/themes/theme-travel-master/assets/wdc-home-hero-diving-clean3.webp') center/cover no-repeat;opacity:.42;z-index:-2}
...
.whaledive-blog .wd-blog-card-body>a{background:rgba(150,218,234,.22)!important;color:#004A98!important;border-color:rgba(0,74,152,.16)!important}
...
.whaledive-blog .wd-blog-card-body>a{background:rgba(150,218,234,.22)!important;color:#004A98!important;-webkit-text-fill-color:#004A98!important}
